import { loadHeaderFooter, getLocalStorage, capFirst, lastUpdate } from "./utils.mjs";
...
function showFavList() {
  ...
  favList.forEach((pokemon) => {
    ...
    li.innerHTML = `<img src="${pokemon.sprites.front_default}" alt="The frontsprite of ${capFirst(pokemon.name)}" width="96" height="96">
